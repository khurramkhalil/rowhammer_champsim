...
with open(constants_header_name, 'wt') as wfp:
    ...
    # Strict variant: safe under 80C double-sided Luo envelope.
    if config_file.get('RP_VTRACK_V2_STRICT', 0):
        print("[RH_DEFENSE] RP_VTRACK_V2_STRICT (80C-DS Luo weights) ENABLE")
        wfp.write("#define RP_VTRACK_V2_STRICT 1\n")
...
with open('Makefile', 'wt') as wfp:
    ...
    wfp.write('LDLIBS := ' + config_file.get('LDLIBS', '-L/storage/home/hcoda1/4/asaxena317/p-mqureshi4-0/art_tracking_rowhammer/DRAMsim3 -ldramsim3') + '\n')
    wfp.write('\n')
